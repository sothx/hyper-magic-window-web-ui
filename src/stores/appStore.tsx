...
import * as appStoreApi from '@/apis/appStoreApi';
...
export const useAppStore = defineStore(
		...
		const appList = ref<AppInfo[]>([
			{
				...
				isShow: () =>
					...
					Boolean(deviceStore.androidTargetSdk && deviceStore.androidTargetSdk === 35),
				versionNum: 20260214,
				description: () => (
					<div>
						...
						<p>
							{' '}
							修复方案仅适配Xiaomi Pad 6 Pro / Xiaomi Pad 6
							Max，请选择自己当前设备对应的选项，其他设备请勿启用以免出现未知问题。
						</p>
					</div>
				),
			...
			},
			{
				...
				versionNum: 20250617,
				url: 'https://caiyun.139.com/m/i?135CmimxMDtEs',
				type: 'info',
				image: '/images/apps/mi_device_connect.jpg',
				tag: 'system',
			},
			{
				id: 'super-xiao-ai',
				...
				description: () => (
					<div>
						...
						<p>
							注意事项: 需要核心破解并搭配MT管理器安装，需要同时安装 超级小爱 和 小米澎湃AI引擎，Hyper OS
							1和MIUI 14需要安装对应文件夹内的版本，否则存在无法使用的问题！
						</p>
					</div>
				),
				url: 'https://caiyun.139.com/m/i?2mWL9yPJ7qhl2',
				type: 'error',
			...
			},
			{
				...
				type: 'warning',
				image: '/images/apps/mi_theme.webp',
				tag: 'original',
			},
			{
			...
			},
			{
				...
				description: () => (
					<div>
						<p>小米平板上的CAJViewer For PC，PC级 CAJViewer 功能体验，操作更高效</p>
			...
			},
			{
				...
				description: () => (
					<div>
						<p>小米平板上的中望CAD For PC，PC级 中望CAD 功能体验，操作更高效</p>
			...
			},
			{
				...
				description: () => (
					<div>
						...
						<p>
							注意事项: Magisk模块请通过对应的 ROOT管理器
							进行安装！传送门管理入口位于[模块设置]，悬浮球管理入口位于[系统设置 - 更多设置 - 悬浮球]。
						</p>
					</div>
				),
			...
			},
			{
				...
				description: () => (
					<div>
						...
						<ul>
							<li>ZRAM: RAM = 1: 1优化(Hyper OS 2 +，仅部分机型支持) </li>
							<li> 启用dm设备映射器(Hyper OS 2 +，仅部分机型支持) </li>
							<li> 启用多档高刷(仅部分机型支持) </li>
							<li> 补全120hz高刷(仅部分机型支持) </li>
							<li> 强开小米平板工作台模式(仅部分机型支持) </li>
							<li> 解除GMS区域限制 </li>
							<li> PC级WPS字体目录自动创建(仅小米 / 红米平板机型支持) </li>
							<li> 解锁熄屏挂机 / 熄屏听剧 </li>
							<li> 解锁视频工具箱智能刷新率 </li>
							<li> 解锁节律护眼(Hyper OS 1 +，仅部分机型支持) </li>
							<li> 开启屏幕旋转建议提示按钮 </li>
							<li> 开启极致模式 </li>
							<li> 开启进游戏三倍速(部分腾讯系游戏) </li>
							<li> 解锁游戏工具箱狂暴引擎UI界面(仅UI效果) </li>
							<li> 解锁游戏音质优化开关 </li>
							<li> 隐藏 / 优化手势提示线(部分机型效果可能不佳) </li>
							<li> 移除OTA验证 </li>
							<li> 开启平滑圆角 </li>
							<li>
								开启高级材质(最高支持到高级材质3.0，部分被阉割了大文件夹模糊的机型，可以自行通过Hyper
								Ceiler强制启用桌面大文件夹的模糊)
							</li>
						</ul>
						<p>
							注意事项: Magisk模块请通过对应的 ROOT管理器 进行安装！高级材质在[显示与亮度 -
							高级材质]，极致模式在[开发者选项 - 极致模式]。
						</p>
					</div>
				),
			...
			},
			{
				...
				description: () => (
					<div>
						...
						<ul>
							<li>ZRAM: RAM = 1: 1优化(Hyper OS 2 +，仅部分机型支持，缺失机型请反馈) </li>
							<li> 启用dm设备映射器(Hyper OS 2 +，需要官方内核，且无data解密) </li>
							<li> 解除GMS区域限制 </li>
							<li> 解锁视频工具箱智能刷新率 </li>
							<li> 解锁节律护眼(Hyper OS 1 +，实际是否支持以系统实际情况为准) </li>
							<li> 开启极致模式 </li>
							<li> 开启进游戏三倍速(部分腾讯系游戏) </li>
							<li> 解锁游戏工具箱狂暴引擎UI界面(仅UI效果) </li>
							<li> 解锁游戏音质优化开关 </li>
							<li> 开启全屏AOD显示(Hyper OS 2 +，实际是否支持以系统实际情况为准) </li>
							<li> 移除OTA验证 </li>
							<li> 开启平滑圆角 </li>
							<li>
								开启高级材质(最高支持到高级材质3.0，部分被阉割了大文件夹模糊的机型，可以自行通过Hyper
				...
				url: 'https://caiyun.139.com/m/i?135CmOdNLkQeu',
				type: 'success',
				image: '/images/apps/magisk.webp',
				tag: 'magisk',
			},
			{
				...
				url: 'https://caiyun.139.com/m/i?135ClZdWPAYZk',
				type: 'error',
				image: '/images/apps/mi_home.png',
				tag: 'system',
			},
			{
				...
				description: () => (
					<div>
						<p>
							...
							Pro，包含九宫格、优化后的动画效果和全新超级小爱Dock便捷入口！
						</p>
						<p> 兼容性: Android 15 Hyper OS 2 </p>
						<p> 注意事项: 如提示系统应用无法安装请从文件管理安装 </p>
					</div>
				),
				url: 'https://caiyun.139.com/m/i?135CmXZPQXz3d',
				type: 'error',
				image: '/images/apps/mi_home.png',
				tag: 'system',
			},
			{
				...
				url: 'https://caiyun.139.com/m/i?135ClUAurszLD',
				type: 'error',
				image: '/images/apps/mi_home.png',
				tag: 'system',
			},
			{
				...
				description: () => (
					<div>
						<p>
							「WinPlay Mobile」是为小米平板量身定做的「游戏虚拟机」，可以运行市面上常见的 Windows 游戏。
						</p>
						<p> 兼容性: 小米平板6S Pro - Hyper OS 2 </p>
						<p>
							注意事项: 需要同时安装 AI百宝箱 和 WAE Display，当前仅兼容小米平板6S
							Pro，且需要运行在最新版的Hyper OS 2.0，[模块设置 - WinPlay
							Mobile]可以快捷打开小米平板的「游戏虚拟机」界面~(其他基于小米平板6S Pro Hyper OS
							2.0的移植包，且作者表明内置了winplay的机型也可以使用！)
						</p>
					</div>
				),
				url: 'https://caiyun.139.com/m/i?135CdoBoOMICY',
				type: 'info',
				image: '/images/icons/win_play_mobile.webp',
				tag: 'system',
			},
			{
				id: 'mi_note_hyper_ai',
				...
				url: 'https://caiyun.139.com/m/i?135Ce9CtGXcVc',
				type: 'warning',
				image: '/images/apps/mi_note.png',
				tag: 'revision',
			},
			{
				id: 'uu_remote',
				...
				url: 'https://caiyun.139.com/m/i?135Cm9zLiXM7U',
				type: 'info',
				image: '/images/apps/uu_remote.jpg',
				tag: 'original',
			},
			{
				...
				url: 'https://caiyun.139.com/m/i?135Ce9CYAY0YN',
				type: 'error',
				image: '/images/apps/mi_soundrecorder.webp',
				tag: 'revision',
			},
			{
				...
				url: 'https://caiyun.139.com/m/i?135Cmo1bvo1XC',
				type: 'info',
				image: '/images/apps/mi_remote.png',
				tag: 'original',
			},
			{
				id: 'qq_music_hd',
				...
				url: 'https://caiyun.139.com/m/i?135CmomGWJWB1',
				type: 'success',
				image: '/images/apps/qq_music.jpg',
				tag: 'original',
			},
			{
				id: 'liuzhou_file',
				...
				url: 'https://caiyun.139.com/m/i?135CmlYwYWyCJ',
				type: 'info',
				image: '/images/apps/liuzhoufile.png',
				tag: 'original',
			},
			{
				id: 'egggame',
				...
				description: () => (
					<div>
						...
						<p>
							现提供三种游戏模式，包括：串流游戏、本地游戏和云游戏。除云游戏外，其他游戏模式均免费。其中串流游戏支持
							PC Link 官方串流和 PS Link 官方串流；本地游戏提供游戏下载运行功能。
						</p>
						<p>
							目前适配骁龙 865
							及以上的安卓手机和安卓掌机，苹果因为系统封闭不支持，天玑和麒麟芯片，目前因为 GPU
							驱动问题不支持，之后会部分支持。目前应用已适配盖世小鸡本品牌手柄。
						</p>
						<p>
							需要注意的是，目前「盖世游戏」App 暂不支持登录 Steam
							下载游戏，官方称“会在后续版本支持一键下载 Steam 游戏和运行，当前版本需要导入游戏”。
						</p>
					</div>
				),
				url: 'https://caiyun.139.com/m/i?135ClWBEBfVxW',
				type: 'default',
				image: '/images/apps/egggame.png',
				tag: 'original',
			},
			{
				id: 'star_note',
				...
				description: () => (
					<div>
						<p>
							笔尖所到，文星高照！文石出品的平板笔记软件，截止 2025 - 2 - 1
							前登录账号即可领取永久的笔记Pro会员！
						</p>
						<p> 兼容性: Hyper OS 1 / Hyper OS 2 / MIUI 14 </p>
				...
				url: 'https://yun.139.com/sharewap/#/m/i?135CmrnDyIHP2',
				type: 'info',
				image: '/images/apps/starNote.webp',
				tag: 'original',
			},
			{
				id: 'free_note',
				...
				url: 'https://caiyun.139.com/m/i?135Clo5BWejq9',
				type: 'default',
				image: '/images/apps/freenote.png',
				tag: 'original',
			},
			{
				...
				url: 'https://caiyun.139.com/m/i?135CmQwFbuC1D',
				type: 'info',
				image: '/images/apps/btremote.png',
				tag: 'original',
			},
			{
				id: 'flix',
				...
				description: () => (
					<div>
						...
						<p>
							{' '}
							多端同步支持，跨品牌无缝传输。全面支持
							Windows，macOS，iOS，Android，Linux，不限系统，不限品牌；
						</p>
						<p> Flix 支持后台传输、断点续传，让传输过程更流畅。</p>
					</div>
				),
				url: 'https://caiyun.139.com/m/i?135ClTD8sxB0G',
				type: 'default',
				image: '/images/apps/flix.png',
				tag: 'original',
			},
			{
				id: 'mi_whitenoise',
				...
				url: 'https://caiyun.139.com/m/i?135Ce3WtvUiKp',
				type: 'success',
				image: '/images/apps/mi_whitenoise.png',
				tag: 'system',
			},
			{
				id: 'express100',
				...
				description: () => (
					<div>
						<p>
							查快递 寄快递
							上快递100，支持直接输入或扫描单号、图片识别、添加手机号等多种查件方式，还可自动保存查件记录，支持多设备多平台同步物流信息。取件、派件、签收、异常等多类型快递状态实时跟踪展示！
						</p>
						<p> 完美横屏应用计划已为快递100通过应用横屏布局适配大屏，欢迎体验！</p>
					</div>
				),
				url: 'https://caiyun.139.com/m/i?135ClmypRCpvN',
				type: 'info',
				image: '/images/apps/kingdee.webp',
				tag: 'original',
			},
			{
				id: 'mi_music_tablet',
				...
				url: 'https://caiyun.139.com/m/i?135CmXllwKaxM',
				type: 'success',
				image: '/images/apps/mi_music.png',
				tag: 'system',
			},
			{
				id: 'qinalt',
				...
				url: 'https://caiyun.139.com/m/i?135ClT9vdg00O',
				type: 'default',
				image: '/images/apps/qinalt.jpg',
				tag: 'original',
			},
			{
				...
				url: 'https://caiyun.139.com/m/i?135Cm6wzXEOyx',
				type: 'info',
				image: '/images/apps/iunistoolsdisplay.png',
				tag: 'original',
			},
			{
				id: 'filmlytv',
				...
				url: 'https://caiyun.139.com/m/i?135ClnUmBJ1EA',
				type: 'warning',
				image: '/images/apps/filmlytv.webp',
				tag: 'original',
			},
			{
				id: 'samsung_browser',
				...
				url: 'https://caiyun.139.com/m/i?135CmXZb9D6PP',
				type: 'info',
				image: '/images/apps/samsung_browser.png',
				tag: 'original',
			},
			{
				id: 'bodian_music',
			...
			},
			{
				...
				description: () => (
					<>
						...
						<p>
							注意事项:
							请使用绑定了网易云音乐的手机账号登录，必须安装荣耀基础服务，荣耀应用市场方便追踪应用更新。
						</p>
					</>
				),
				url: 'https://caiyun.139.com/m/i?135CmrVUbH2y3',
				type: 'error',
				image: '/images/apps/honor_music.png',
				tag: 'original',
			},
			{
				id: 'pianoperfect',
				...
				url: 'https://caiyun.139.com/m/i?135Cdn7Uss9KJ',
				type: 'info',
				image: '/images/apps/pianoperfect.webp',
				tag: 'original',
			},
			{
				id: 'flipaclip',
				...
				description: () => (
					<>
						...
						<p>
							FlipaClip
							强大而有趣的工具可以让你一帧一帧地轻松制作动画，无论你是要打草稿、做脚本、做动画或者至少想要学习，FlipaClip足以实现您的创意。
						</p>
					</>
				),
				url: 'https://caiyun.139.com/m/i?135Ce7Ou7DwWV',
				type: 'default',
				image: '/images/apps/flipaclip.png',
				tag: 'original',
			},
			{
				id: 'habicat',
				...
				description: () => (
					<>
						...
						<p>
							注意事项:
							完美横屏应用计划已为像素习惯通过应用布局优化适配大屏，请确保你安装的模块版本和系统版本支持应用布局优化。
						</p>
					</>
				),
				url: 'https://caiyun.139.com/m/i?135Ce9wkd3aKT',
				type: 'info',
				image: '/images/apps/habicat.webp',
				tag: 'original',
			},
			{
				id: 'gamecores',
				...
				url: 'https://caiyun.139.com/m/i?135CmUfDZ6yV8',
				type: 'default',
				image: '/images/apps/gamecores.webp',
				tag: 'original',
			},
			{
				...
				description: () => (
					<>
						...
						<p>
							注意事项: 需要搭配 LSPosed 模块主题破解进行食用，[模块设置 -
							导入个性化]可以快捷打开小米平板的主题导入界面~
						</p>
					</>
				),
				url: 'https://caiyun.139.com/m/i?135CltA2z1VvD',
				type: 'warning',
				image: '/images/apps/mi_theme.webp',
				tag: 'original',
			},
			{
				...
				description: () => (
					<>
						...
						<p>
							有诗，你的口袋诗库，这里收录了数十万首传统诗词与现代诗词，每日自动推荐最适合您的作品，让您在忙碌的生活中也能轻松欣赏诗词之美。我们希望，所有渴望被触碰心灵的、真实而纯粹的灵魂，在诗歌里获得片刻自由，远方未远，诗歌正好，让我们一起拥抱诗意生活。
						</p>
						<p> 完美横屏应用计划已为有诗通过应用横屏布局适配大屏，欢迎体验！</p>
					</>
				),
				url: 'https://caiyun.139.com/m/i?135CmCz8VCpu0',
				type: 'default',
				image: '/images/apps/youshi.webp',
				tag: 'original',
			},
			{
				id: 'sspai',
				...
				description: () => (
					<>
						<p>
							...
							和数字产品、学习有效方法论，从而大大提高效率和生活品质的内容平台。
						</p>
						<p> 完美横屏应用计划已为少数派通过应用横屏布局和第三方应用横屏优化适配大屏，欢迎体验！</p>
					</>
				),
				url: 'https://caiyun.139.com/m/i?135Clqi1SPjAp',
				type: 'error',
				image: '/images/apps/sspai.png',
				tag: 'original',
			},
			{
				id: 'brain_music',
				...
				url: 'https://caiyun.139.com/m/i?135ClnqRKur1n',
				type: 'info',
				image: '/images/apps/brainmusic.jpg',
				tag: 'original',
			},
		]);
		const mergedAppList = computed(() => {
			return appList.value.map(item => {
				const currentRemoteInfo = getRemoteInfoByID(item.id);
				if (currentRemoteInfo && currentRemoteInfo.versionNum > item.versionNum) {
					item.versionNum = currentRemoteInfo.versionNum;
					item.url = currentRemoteInfo.url;
				}
				return item;
			});
		});
		const getRemoteInfoByID = (id?: string) => {
			if (!id) {
				return undefined;
			}
			return remoteDownloadAppUrlMap.value[id];
		};
	...
	{
		persist: {
			pick: ['remoteDownloadAppUrlMap', 'hasClickUpdateTips'],
		},
	},
);
