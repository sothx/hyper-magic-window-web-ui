...
const navigation = [
  { name: '应用横屏配置', href: '#', icon: HomeIcon, current: true },
              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                ...
                <nav class="flex flex-1 flex-col">
                  <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    ...
                    <li class="mt-auto">
                      <router-link to="/settings" class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-indigo-600"></router-link>
