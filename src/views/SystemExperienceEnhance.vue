			...
			<>
				...
				{miScreenShotsWriteClipboard.isEnable.value && (
					<n-alert class='mt-5' type='info' show-icon={false} bordered={false}>
						<div>
							<p>
								由于小米已经废弃了该功能，模块提供「开机自配置」来解决这个问题，开启后每次开机30秒后会自动启用「截图自动添加至剪贴板」。
							</p>
							<p>
								请注意！由于该功能已经被小米废弃，小米会通过「手机管家/平板管家」强制覆写为「关闭」状态，如果强制结束「手机管家/平板管家」的后台，会导致「截图自动添加至剪贴板」再次被关闭，需要手动重新启用~
							</p>
							<n-switch
