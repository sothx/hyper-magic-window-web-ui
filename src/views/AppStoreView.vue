	...
	},
	{
		...
		description: (
			<div>
				...
				<p>
					注意事项: 需要核心破解并搭配MT管理器安装，需要同时安装 超级小爱 和 小米澎湃AI引擎，Hyper OS 1和MIUI
					14需要安装对应文件夹内的版本，否则存在无法使用的问题！
				</p>
			</div>
		),
	...
	},
	{
		...
		description: (
			<div>
				...
				<p>
					注意事项: Magisk模块请通过对应的 ROOT管理器
					进行安装！高级材质在[显示与亮度-高级材质]，极致模式在[开发者选项-极致模式]。
				</p>
			</div>
		),
	...
	},
	{
		...
		description: (
			<div>
				...
				<p>
					注意事项: 需要同时安装 AI百宝箱 和 WAE Display，当前仅兼容小米平板6S Pro，且需要运行在最新版的Hyper
					OS 2.0，[模块设置-WinPlay Mobile]可以快捷打开小米平板的「游戏虚拟机」界面~(其他基于小米平板6S Pro
					Hyper OS 2.0的移植包，且作者表明内置了winplay的机型也可以使用！)
				</p>
			</div>
		),
	...
	},
	{
		...
		description: (
			<div>
				...
				<p>
					目前适配骁龙 865 及以上的安卓手机和安卓掌机，苹果因为系统封闭不支持，天玑和麒麟芯片，目前因为 GPU
					驱动问题不支持，之后会部分支持。目前应用已适配盖世小鸡本品牌手柄。
				</p>
				<p>
					需要注意的是，目前「盖世游戏」App 暂不支持登录 Steam 下载游戏，官方称“会在后续版本支持一键下载 Steam
					游戏和运行，当前版本需要导入游戏”。
				</p>
			</div>
		),
	...
	},
	{
		...
		description: (
			<>
				...
				<p>
					注意事项: 请使用绑定了网易云音乐的手机账号登录，必须安装荣耀基础服务，荣耀应用市场方便追踪应用更新。
				</p>
			</>
		),
	...
	},
	{
		...
		description: (
			<>
				...
				<p>
					注意事项: 需要搭配 LSPosed
					模块主题破解进行食用，[模块设置-导入个性化]可以快捷打开小米平板的主题导入界面~
				</p>
			</>
		),
